"""Event entity for Pool Tracker chemical additions."""
...
async def async_setup_entry(
    ...
    """Set up one chemical-addition event entity per pool."""
...
class PoolChemicalAdditionEvent(EventEntity):
    ...
    async def async_added_to_hass(self) -> None:
        """Subscribe to the event log without replaying historical additions."""
        latest = self.store.latest_record(RECORD_TYPE_CHEMICAL_ADDITION, self.pool_id)
    ...
    def _handle_store_update(self) -> None:
        ...
        self._trigger_event(EVENT_TYPE_CHEMICAL_ADDITION, _event_attributes(latest))
